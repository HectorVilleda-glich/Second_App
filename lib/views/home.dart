...
class _HomePageState extends State<HomePage> {
  ...
  void _removeTask(int index) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text("¿Deseas Eliminar la Tarea?"),
        actions: [
          TextButton(
            onPressed: () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Tareas Actuales ($pendingTasks Pendientes)"),
        centerTitle: true,
      ),
      body: Column(
        children: [
          Expanded(
            child: _tasks.isEmpty
                ? const Center(child: Text("Actualmente no hay tareas agregadas"))
                : ListView.builder(
                    ...
                    children: [
                      TextField(
                        ...
                        decoration: const InputDecoration(
                          hintText: "Escriba la tarea a realizar",
                        ),
                      ),
                      TextField(
                        controller: _descriptionController,
                        decoration: const InputDecoration(
                          hintText: "Coloque una descripción",
                        ),
                      ),
